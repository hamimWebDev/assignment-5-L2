...
import CreateAdminOrUserModal from "./CreateAdmin";
...
const Admin = () => {
  ...
  const toggleModalCreate = () =>
    setIsCreateAdminOrUserModalOpen(!isCreateAdminOrUserModalOpen);
  return (
    <div>
      ...
      <div>
        ...
        <CreateAdminOrUserModal
          isCreateAdminOrUserModalOpen={isCreateAdminOrUserModalOpen}
          setIsCreateAdminOrUserModalOpen={setIsCreateAdminOrUserModalOpen}
        />
        <div className="pt-20">
          <Outlet />
        </div>
